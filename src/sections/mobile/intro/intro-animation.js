...
function IntroAnimation () {
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      gsap.to('.mobile-container .c1', { // blue
        keyframes: {
          '0%': { 
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c2', { // crimson
        keyframes: {
          '0%': { 
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c3', { // gold
        keyframes: {
          '0%': { 
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c4', { // hotpink
        keyframes: {
          '0%': { 
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c5', { // limegreen
        keyframes: {
          '0%': { 
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c6', { // maroon
        keyframes: {
          '0%': {
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c7', { // seagreen
        keyframes: {
          '0%': {
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .c8', { // turquoise 
        keyframes: {
          '0%': { 
            left: moveX.start,
            top: moveY.start,
      ...
      gsap.to('.mobile-container .atl-wyb-cir', {
        keyframes: {
          '0%': { opacity: 1 },
          '10%': { opacity: 0 },
        },
      ...
      gsap.to('.mobile-container .atl-wyb, .mobile-container .atl_logo', {
        onStart:() => {
          document.querySelector('.mobile-container .square-move .atl_logo').style.left = window.outerWidth / 2 - 168;
        },
        keyframes: {
          '0': { opacity: 0 },
          '98%': { opacity: 0 },
      ...
      gsap.to('.mobile-container .atl-wyb', {
        opacity: 0,
        delay: animationTime + delayTime * 2,
        duration: 2,
      });

      gsap.to('.mobile-container .atl_logo', {
        top: 0,
        left: window.outerWidth / 2 - 121,
        width: 62,
        color: '#e12d2d',
        delay: animationTime + delayTime * 2,
        duration: 2,
        ...
        <div style={{ 
          ...
          <div className='flex square-move o-hidden'>
            ...
            <div className='circle play flex align-center hidden' onClick={() => {
              console.log(c1)
              const video = document.querySelector('.mobile-container video');
